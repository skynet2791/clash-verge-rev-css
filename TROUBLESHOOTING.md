# Clash Verge Rev 自定义 CSS 踩坑与最佳实践记录

在使用自定义 CSS 美化 Clash Verge Rev 客户端（特别是基于 Shadcn 风格进行深度定制）时，可能会遇到各种不可预见的渲染问题或冲突。本文档专门用于记录开发过程中的各类踩坑经验与最佳实践。

---

## 一、 代理节点与图标渲染篇

国旗和代理节点图标的渲染极易受全局样式干扰。经过排查，解法总结如下：
